...
class ResConfigSettings(models.TransientModel):
    ...
    def _compute_pos_discount_product_id(self):
        def_product = self.env.ref("point_of_sale.product_product_consumable", raise_if_not_found=False)
        for res_config in self:
            discount_product = res_config.pos_config_id.discount_product_id or def_product
