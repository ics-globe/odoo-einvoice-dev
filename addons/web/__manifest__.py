...
""",
    ...
    'assets': {
        ...
        'web.assets_common_bs4': [
            ...
            ('include', 'web._assets_common_styles'),
            ('include', 'web.assets_common_minimal'),
            ('include', 'web._assets_common_scripts_bs4'),
        ],
        ...
        'web._assets_helpers_bs4': [
            'web/static/lib/bootstrap-4/scss/_functions.scss',
            'web/static/lib/bootstrap-4/scss/_mixins.scss',
            'web/static/src/legacy/scss/bs_mixins_overrides.scss',
            'web/static/src/legacy/scss/utils.scss',
        ...
        'web._assets_common_scripts': [
            ...
            'web/static/lib/popper-2/popper.js',
        ...
        'web._assets_common_scripts_bs4': [
            'web/static/lib/underscore/underscore.js',
            'web/static/lib/underscore.string/lib/underscore.string.js',
            'web/static/lib/moment/moment.js',
            'web/static/lib/owl/owl.js',
            ...
            'web/static/lib/bootstrap-4/js/index.js',
            'web/static/lib/bootstrap-4/js/util.js',
            'web/static/lib/bootstrap-4/js/alert.js',
            'web/static/lib/bootstrap-4/js/button.js',
            'web/static/lib/bootstrap-4/js/carousel.js',
            'web/static/lib/bootstrap-4/js/collapse.js',
            'web/static/lib/bootstrap-4/js/dropdown.js',
            'web/static/lib/bootstrap-4/js/modal.js',
            'web/static/lib/bootstrap-4/js/tooltip.js',
            'web/static/lib/bootstrap-4/js/popover.js',
            'web/static/lib/bootstrap-4/js/scrollspy.js',
            'web/static/lib/bootstrap-4/js/tab.js',
            'web/static/lib/bootstrap-4/js/toast.js',
            'web/static/lib/tempusdominus/tempusdominus.js',
            'web/static/lib/select2/select2.js',
            'web/static/lib/clipboard/clipboard.js',
            'web/static/lib/jSignature/jSignatureCustom.js',
