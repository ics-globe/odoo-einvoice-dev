...
QUnit.module('basic_fields', {
    ...
    QUnit.test('use boolean toggle widget in form view', async function (assert) {
        ...
        assert.containsOnce(form, ".form-check.o_boolean_toggle .fa-check-circle",
            "Boolean toggle should have fa-check-circle icon");

        await testUtils.dom.click(form.$('.o_field_widget[name=bar]'));
        assert.containsOnce(form, ".form-check.o_boolean_toggle .fa-times-circle",
    ...
    QUnit.test('label_selection widget in form view', async function (assert) {
        ...
        assert.containsOnce(form, '.o_field_widget.badge.bg-warning.text-dark',
            "should have a warning status label since selection is the second, blocked state");
        assert.containsNone(form, '.o_field_widget.badge.bg-secondary',
            "should not have a default status since selection is the second, blocked state");
        assert.containsNone(form, '.o_field_widget.badge.bg-success',
            "should not have a success status since selection is the second, blocked state");
        assert.strictEqual(form.$('.o_field_widget.badge.bg-warning.text-dark').text(), 'Blocked',
    ...
    QUnit.test('label_selection widget in editable list view', async function (assert) {
        ...
        assert.containsOnce(list, '.o_field_widget.badge.bg-warning.text-dark',
            "should have one warning status label");
        assert.strictEqual(list.$('.o_field_widget.badge.bg-warning.text-dark').text(), 'Blocked',
            "the warning label should read 'Blocked'");
        assert.containsOnce(list, '.o_field_widget.badge.bg-secondary',
            "should have one default status label");
        assert.strictEqual(list.$('.o_field_widget.badge.bg-secondary').text(), 'Normal',
            "the default label should read 'Normal'");
        assert.containsOnce(list, '.o_field_widget.badge.bg-success',
            "should have one success status label");
        assert.strictEqual(list.$('.o_field_widget.badge.bg-success').text(), 'Done',
