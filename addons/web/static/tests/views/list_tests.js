...
QUnit.module('Views', {
    ...
    QUnit.test("update control panel while list view is mounting", async function (assert) {
        ...
        // const unPatchedMounted = ControlPanel.prototype.mounted;
        // ControlPanel.prototype.mounted = function () {
        //     assert.step(`mountedCounterCall-${++mountedCounterCall}`);
        //     unPatchedMounted.apply(this, arguments);
        // }
            ...
            config: Object.assign({}, ListView.prototype.config, {
                Controller: ListController.extend({
                    async start() {
                        ...
                        this._controlPanelWrapper.update({ withBreadcrumbs: this._controlPanelWrapper.props.withBreadcrumbs })
                    },
                }),
            }),
        });
        ...
        // ControlPanel.prototype.mounted = unPatchedMounted
    });
