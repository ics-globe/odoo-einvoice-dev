...
class ResCompany(models.Model):
    ...
    transfer_account_id = fields.Many2one('account.account',
        domain=lambda self: [('reconcile', '=', True), ('account_type', '=', 'data_account_type_current_assets'), ('deprecated', '=', False)], string="Inter-Banks Transfer Account", help="Intermediary account used when moving money from a liqity account to another")
    ...
    def setting_chart_of_accounts_action(self):
        ...
        domain = [('account_type', '!=', 'data_unaffected_earnings'), ('company_id','=', company)]
        return {
            'type': 'ir.actions.act_window',
    ...
    def get_unaffected_earnings_account(self):
        ...
        """
        unaffected_earnings_type = "data_unaffected_earnings"
