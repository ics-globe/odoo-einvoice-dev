...
class AccountMoveLine(models.Model):
    ...
    def _prepare_reconciliation_single_partial(self, debit_vals, credit_vals):
        ...
        def get_odoo_rate(vals):
            return recon_currency._get_conversion_rate(company_currency, recon_currency, vals['company'], vals['date'])
        ...
        partials_vals_list, exchange_data = self._prepare_reconciliation_partials([
            {
                ...
                'amount_residual': x.amount_residual,
                'amount_residual_currency': x.amount_residual_currency,
