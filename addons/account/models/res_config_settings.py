...
class ResConfigSettings(models.TransientModel):
    ...
    account_journal_suspense_account_id = fields.Many2one(
        ...
        domain=lambda self: "[('deprecated', '=', False), ('company_id', '=', company_id), ('account_type', 'not in', ('receivable', 'payable')), ('account_type', '=', %s)]" % 'data_account_type_current_liabilities'),
    ...
    account_journal_payment_debit_account_id = fields.Many2one(
        ...
        domain=lambda self: "[('deprecated', '=', False), ('company_id', '=', company_id), ('account_type', 'not in', ('receivable', 'payable')), ('account_type', '=', %s)]" % 'data_account_type_current_assets'),
    ...
    transfer_account_id = fields.Many2one('account.account', string="Internal Transfer Account",
        ...
        domain=lambda self: [('reconcile', '=', True), ('account_type', '=', 'data_account_type_current_assets'))],
