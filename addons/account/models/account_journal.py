...
class AccountJournal(models.Model):
    ...
    currency_id = fields.Many2one('res.currency', help='The currency used to enter statement', string="Currency", compute='_compute_journal_currency', store=True, readonly=False)
    ...
    def _compute_journal_currency(self):
        for journal in self:
            if journal.type in ('bank', 'cash') and not journal.currency_id:
