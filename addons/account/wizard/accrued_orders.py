...
class AccruedExpenseRevenue(models.TransientModel):
    ...
    def _get_account_domain(self):
        if self.env.context.get('active_model') == 'purchase.order':
            return [('account_type', '=', 'data_account_type_current_liabilities'), ('company', '=', self._get_default_company())]
        else:
            return [('account_type', '=', 'data_account_type_current_assets'), ('company', '=', self._get_default_company())]
