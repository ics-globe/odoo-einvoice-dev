...
export class WebsocketBus {
    constructor(env, websocketService) {
        ...
        this._userUpdatePeriod = 30000; // update user presence every 30s
    ...
    */
     ...
     * @param {Object} kwargs Keyword arguments to pass to the route
     */
    send(path, kwargs) {
        this.websocketService.send({ path, kwargs });
    }
    ...
    /**
     * Update user presence every _userUpdatePeriod seconds.
     *
     * @private
     */
