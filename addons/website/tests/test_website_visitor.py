...
class WebsiteVisitorTests(MockVisitor, HttpCaseWithUserDemo):
    ...
    def test_visitor_creation_on_tracked_page(self):
        ...
        self.assertEqual(len(new_track), 2, "There should be 1 tracked page")
        ...
        self.assertEqual(len(visitor_admin.website_track_ids), 5, "There should be 4 tracked page for the admin")
