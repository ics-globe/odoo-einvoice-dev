...
class TestCowViewSaving(TestViewSavingCommon):
    ...
    def test_cow_leaf(self):
        ...
        arch = self.base_view.with_context(website_id=1).get_arch()
    ...
    def test_cow_root(self):
        ...
        arch = generic_base_view.with_context(load_all_views=True).get_arch()
        self.assertEqual(arch, '<div>modified base content, extended content</div>')

        arch = website_specific_base_view.with_context(load_all_views=True, website_id=1).get_arch()
    ...
    def test_cow_complete_flow(self):
        ...
        arch = base_specific.with_context(website_id=1).get_arch()
        ...
        base_arch = self.base_view.get_arch()
        base_arch_w1 = self.base_view.with_context(website_id=1).get_arch()
    ...
    def test_cow_cross_inherit(self):
        ...
        generic_view_arch = View.browse(generic_view).with_context(load_all_views=True).get_arch()
        specific_view_arch = View.browse(specific_view).with_context(load_all_views=True, website_id=1).get_arch()
    ...
    def test_module_new_inherit_view_on_parent_already_forked(self):
        ...
        specific_view_arch = specific_view.get_arch()
        ...
        specific_view_arch = Website.with_context(load_all_views=True, website_id=1).viewref('_website_sale.product').get_arch()
