...
class PurchaseOrderLine(models.Model):
    ...
    date_planned = fields.Datetime(
        ...
        compute="_compute_price_unit_and_date_planned", readonly=False, store=True,
    ...
    def _compute_price_unit_and_date_planned(self):
        ...
        for line in self:
            ...
            if not seller:
                ...
                if price_unit and line.order_id.currency_id and line.order_id.company_id.currency_id != line.order_id.currency_id:
                    price_unit = line.order_id.company_id.currency_id._convert(
                        price_unit,
            ...
            if price_unit and seller and line.order_id.currency_id and seller.currency_id != line.order_id.currency_id:
                price_unit = seller.currency_id._convert(
                    price_unit, line.order_id.currency_id, line.order_id.company_id, line.date_order or fields.Date.today())
            ...
            line.price_unit = price_unit
            if (line.name in default_names or not line.name):
