...
class HrEmployeePrivate(models.Model):
    ...
    def get_view(self, view_id=None, view_type='form', **options):
        if self.check_access_rights('read', raise_exception=False):
            return super(HrEmployeePrivate, self).get_view(view_id=view_id, view_type=view_type, **options)
        return self.env['hr.employee.public'].get_view(view_id=view_id, view_type=view_type, **options)
