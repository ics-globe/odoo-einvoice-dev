...
class Meeting(models.Model):
    ...
    def _google_values(self):
        ...
        attendee_values = [{'email': attendee.sudo().partner_id.email_normalized, 'responseStatus': attendee.state}
                           for attendee in attendees if attendee.sudo().partner_id.email_normalized]
