...
export class Dialog extends Component {
    ...
    constructor(...args) {
        ...
        useStore(props => {
            const dialog = this.env.models['discuss.dialog'].get(props.dialogLocalId);
            return {
    ...
    /**
     * @returns {discuss.dialog}
     */
    get dialog() {
        return this.env.models['discuss.dialog'].get(this.props.dialogLocalId);
    }
