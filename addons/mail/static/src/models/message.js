...
registerModel({
        ...
        convertData(data) {
            ...
            if ('tracking_value_ids' in data) {
                data2.trackingValues = insertAndReplace(data.tracking_value_ids.map(trackingData => 
                    this.messaging.models['MessageTrackingValue'].convertData(trackingData)
                ));
            }
    ...
    recordMethods: {
         ...
         */
        _computeOrderedTrackingValues() {
            return replace(this.trackingValues);
        },
        /**
    ...
    fields: {
         ...
         */
        lastTrackingValue: one('MessageTrackingValue', {
        ...
        orderedTrackingValues: many('MessageTrackingValue', {
            compute: '_computeOrderedTrackingValues',
            isCausal: true,
        ...
        trackingValues: many('MessageTrackingValue', {
            inverse: 'message',
            isCausal: true,
        }),
    },
