...
function factory(dependencies) {
    ...
    class MessagingInitializer extends dependencies['mail.model'] {
        ...
        /**
         * @param {object} resUserSettings
         * @param {integer} resUserSettings.id
         * @param {boolean} resUserSettings.is_discuss_sidebar_category_channel_open
         * @param {boolean} resUserSettings.is_discuss_sidebar_category_chat_open
