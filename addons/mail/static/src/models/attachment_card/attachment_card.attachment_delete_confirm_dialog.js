...
registerModel({
    name: 'AttachmentCard.AttachmentDeleteConfirmDialog',
    identifyingFields: ['attachmentCardOwner'],
    recordMethods: {
        _computeDialog() {
    ...
    fields: {
        attachmentCardOwner: one('AttachmentCard', {
        ...
        attachmentDeleteConfirmView: one('AttachmentDeleteConfirmView', {
            ...
            inverse: 'attachmentCardAttachmentDeleteConfirmDialogOwner',
            isCausal: true,
            readonly: true,
            required: true,
        }),
