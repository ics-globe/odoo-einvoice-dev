        ...
        return {
            ...
            'mail.activity': {
                fields: {
                    ...
                    create_date: { string: "Create Date", type: "date", default() { return moment().format('YYYY-MM-DD'); } },
                    create_uid: { string: "Created By", type: "many2one", relation: 'res.users' },
                    ...
                    request_partner_id: { string: "requesting partner", type: 'many2one', relation: 'res.partner' },
