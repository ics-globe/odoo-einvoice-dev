...
class PaymentToken(models.Model):
    ...
    def _mercado_pago_sca_migrate_customer(self):
        ...
        response_content = self.acquirer_id._mercado_pago_make_request(
            'payment_methods',
            payload={
        ...
        if not payment_method_id:
            raise ValidationError("Mercado Pago: " + _("Unable to convert payment token to new API."))
        self.mercado_pago_payment_method = payment_method_id
