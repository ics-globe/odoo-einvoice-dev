...
const HRFleetListController = ListController.extend({
    buttons_template: 'HRFleetListView.buttons',
...
const HRFleetListView = ListView.extend({
    config: _.extend({}, ListView.prototype.config, {
        Controller: HRFleetListController,
    }),
})

viewRegistry.add('hr_fleet_list_view', HRFleetListView);
