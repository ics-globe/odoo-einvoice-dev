...
class TestSaleStockInvoices(TestSaleCommon):
    ...
    def test_backorder_and_several_invoices(self):
        ...
        html = report._render_qweb_html('account.report_invoice_with_payments', invoice01.ids)[0]
        text = html2plaintext(html)
        ...
        html = report._render_qweb_html('account.report_invoice_with_payments', invoice02.ids)[0]
        text = html2plaintext(html)
