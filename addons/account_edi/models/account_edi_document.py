    ...
    def _compute_edi_content(self):
        for doc in self:
            ...
            if doc.state in ('to_send', 'to_cancel'):
                ...
                elif move._is_edi_invoice(include_receipts=True) and doc.edi_format_id._is_required_for_invoice(move):
    ...
    def _prepare_jobs(self):
        ...
        * doc_type:       Are the moves of this job invoice or payments ?
        ...
        for edi_doc in documents:
            ...
            if move._is_edi_invoice(include_receipts=True):
                doc_type = 'invoice'
        ...
        def _postprocess_cancel_edi_results(documents, edi_result):
            ...
            for document in documents:
                ...
                if move_result.get('success') is True:
                    ...
                    if move._is_edi_invoice(include_receipts=True) and move.state == 'posted':
