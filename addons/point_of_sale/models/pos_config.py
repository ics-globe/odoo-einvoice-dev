...
class PosConfig(models.Model):
    ...
    def _set_default_on_vals(self, vals):
        if 'tip_product_id' in vals and not vals['tip_product_id']:
            vals['tip_product_id'] = self.env.ref('point_of_sale.product_product_tip', False).id

    def write(self, vals):
        self._set_default_on_vals(vals)
    ...
    # TODO-JCB: Maybe we can move this logic in `_set_default_on_vals`
