...
function changeTemplate(templateKey) {
    ...
    return [
        ...
        {trigger: `.s_dynamic_snippet_products.${templateClass} .carousel`},
    ];
}
...
tour.register('website_sale.snippet_products', {
    test: true,
    url: '/',
},
[
    ...
    {
        trigger: ".s_dynamic_snippet_products .o_carousel_product_card_body .js_add_cart",
        run: 'click',
    },
    wSaleTourUtils.goToCart(),
]);

tour.register('website_sale.products_snippet_recently_viewed', {
    test: true,
    url: '/',
},
[
    ...
    ...wTourUtils.clickOnSave(),
    {
        ...
        trigger: '.s_dynamic_snippet_products .o_carousel_product_card',
        run: function () {
            $('.s_dynamic_snippet_products .o_carousel_product_card .js_remove').attr('style', 'display: block;');
        }
    },
    {
        trigger: '.s_dynamic_snippet_products .o_carousel_product_card .js_remove',
        run: 'click',
    },
]);
