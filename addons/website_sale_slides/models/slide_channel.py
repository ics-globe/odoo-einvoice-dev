...
class Channel(models.Model):
    ...
    def _synchronize_product_publish(self):
        ...
        product_to_unpublished = unpublished_channel_products - self.env['product.product'].browse(used_product_ids)
        if product_to_unpublished:
            product_to_unpublished.sudo().write({'is_published': False})
