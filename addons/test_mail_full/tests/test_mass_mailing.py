    ...
    def test_mailing_w_blacklist_opt_out(self):
        ...
        for recipient in recipients_all:
            ...
            # falsy: error (failed mail)
                ...
                self.assertEqual(
                    mailing._generate_mailing_recipient_hash(unsubscribe_params['res_id'], (unsubscribe_params['email'])),
                ...
                self.assertEqual(
                    mailing._generate_mailing_recipient_hash(view_params['res_id'], (view_params['email'])),
                    view_params['token']
                )
