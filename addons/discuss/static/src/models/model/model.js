...
function factory() {
    ...
    class Model {
         ...
         *
         * The result of this function is used to index and find records based
         * on their identifying data.
         *
         * @static
         * @private
         * @param {Object} data
     ...
     * objects, @see `discuss/static/src/model/model_field.js`
     *
     ...
     */
    Model.modelName = 'discuss.model';

    return Model;
}

registerNewModel('discuss.model', factory);
