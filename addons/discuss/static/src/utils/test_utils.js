...
import {
    addMessagingToEnv,
    addTimeControlToEnv,
} from '@discuss/env/test_env';
import { ModelManager } from '@discuss/model/model_manager';
import ChatWindowService from '@discuss/services/chat_window_service/chat_window_service';
import DialogService from '@discuss/services/dialog_service/dialog_service';
import { nextTick } from '@discuss/utils/utils';
import DiscussWidget from '@discuss/widgets/discuss/discuss';
import MessagingMenuWidget from '@discuss/widgets/messaging_menu/messaging_menu';
import { MockModels } from '@discuss/../tests/helpers/mock_models';
 ...
 *   not initialized, test should mock RPC `discuss/init_messaging` and block its
 *   resolution.
...
async function start(param0 = {}) {
    ...
    const start = async () => {
        messagingBeforeCreationDeferred.then(async () => {
             ...
             */
            testEnv.messaging = testEnv.models['discuss.messaging'].create();
