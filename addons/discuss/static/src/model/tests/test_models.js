...
function factoryAddress(dependencies) {
    class Address extends dependencies['discuss.model'] {
...
function factoryContact(dependencies) {
    class Contact extends dependencies['discuss.model'] {}
...
function factoryHobby(dependencies) {
    class Hobby extends dependencies['discuss.model'] {}
...
function factoryTask(dependencies) {
    class Task extends dependencies['discuss.model'] {
        static _createRecordLocalId(data) {
            if (data.id) {
                return `${this.modelName}_${data.id}`;
            } else {
