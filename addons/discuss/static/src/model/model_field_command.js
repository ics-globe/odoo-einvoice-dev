 ...
 *
 * @param {discuss.model|discuss.model[]} newValue - record or records array to be linked.
 * @returns {FieldCommand}
 */
 ...
 * for a x2many field.
 *
 * @param {discuss.model|discuss.model[]} newValue - record or records array to be replaced.
 * @returns {FieldCommand}
 */
 ...
 *  for a x2many field.
 *
 * @param {discuss.model|discuss.model[]} [data] - record or records array to be unlinked.
