...
import { clear, FieldCommand, link, replace, unlink, unlinkAll } from '@discuss/model/model_field_command';
...
export class ModelField {
     ...
     *
     * @private
     * @param {discuss.model|discuss.model[]} newValue
     * @param {Object} [param1={}]
     ...
     * @private
     * @param {discuss.model} record
     * @param {discuss.model} recordToLink
     * @param {Object} [param2={}]
     * @param {boolean} [param2.hasToUpdateInverse=true] whether updating the
     *  current field should also update its inverse field. Typically set to
     *  false only during the process of updating the inverse field itself, to
