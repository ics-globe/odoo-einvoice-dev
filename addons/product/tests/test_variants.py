...
class TestVariants(common.TestProductCommon):
    ...
    def test_dynamic_variants_copy(self):
        ...
        variant_dny = template_dyn._create_product_variant(template_dyn._get_first_possible_combination())
        self.assertEqual(len(template_dyn.product_variant_ids), 1)

        variant_dny_copy = variant_dny.copy()
        template_dyn_copy = variant_dny_copy.product_tmpl_id
