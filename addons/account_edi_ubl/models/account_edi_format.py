...
class AccountEdiFormat(models.Model):
    ...
    def _create_invoice_from_xml_tree(self, filename, tree, journal=None):
        # OVERRIDE
        self.ensure_one()
        if self.code == 'ubl_2_1' and self._is_ubl(filename, tree) and not hasattr(self, '_infer_xml_builder_from_tree'):
    ...
    def _post_invoice_edi(self, invoices):
        # OVERRIDE
        self.ensure_one()
        if self.code != 'ubl_2_1' or hasattr(self, '_infer_xml_builder_from_tree'):
