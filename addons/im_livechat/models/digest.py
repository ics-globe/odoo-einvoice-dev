...
class Digest(models.Model):
    ...
    def _compute_kpi_livechat_rating_value(self):
        ...
        self.kpi_livechat_rating_value = ratings['great'] * 100 / sum(ratings.values()) if sum(ratings.values()) else 0
    ...
    def _compute_kpi_livechat_response_value(self):
        ...
        ], ['partner_id', 'time_to_answer'], ['partner_id'])

        self.kpi_livechat_response_value = "%.2f" % sum([
