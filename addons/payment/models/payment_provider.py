...
class PaymentProvider(models.Model):
    ...
    country_ids = fields.Many2many(
        ...
        help="The countries for which this payment provider is available.\n"
    ...
    def _check_required_if_provider(self):
        ...
        for all payment.provider records with the `provider` field equal to <provider> and with the
        ...
        """
        field_names = []
        enabled_providers = self.filtered(lambda pro: pro.state in ['enabled', 'test'])
