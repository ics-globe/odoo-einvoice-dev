...
class StockMoveLine(models.Model):
    ...
    move_location_id = fields.Many2one(related='move_id.location_id')
    move_location_dest_id = fields.Many2one(related='move_id.location_dest_id')
    move_product_id = fields.Many2one(related='move_id.product_id', string="Move Product")
    ...
    picking_show_lots_text = fields.Boolean(related='picking_id.show_lots_text')
    picking_immediate_transfer  = fields.Boolean(related='picking_id.immediate_transfer')
