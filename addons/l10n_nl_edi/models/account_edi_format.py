...
class AccountEdiFormat(models.Model):
    ...
    def _check_move_configuration(self, invoice):
        ...
        if self.code != 'nlcius_1' or hasattr(self, '_get_edi_ubl_cii_builder'):
            return errors
    ...
    def _create_invoice_from_xml_tree(self, filename, tree, journal=None):
        self.ensure_one()
        if self.code == 'nlcius_1' and self._is_nlcius(filename, tree) and not hasattr(self, '_get_edi_ubl_cii_builder'):
