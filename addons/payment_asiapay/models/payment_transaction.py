...
class PaymentTransaction(models.Model):
    ...
    def _get_specific_rendering_values(self, processing_values):
        ...
        rendering_values = {
            ...
            "amount": self.currency_id._convert(self.amount, self.acquirer_id.asiapay_currency_id, self.company_id, fields.Date.today()),
        ...
        if self.acquirer_id.asiapay_secure_hash:
            args = {
                ...
                'amount': str(self.currency_id._convert(self.amount, self.acquirer_id.asiapay_currency_id, self.company_id, fields.Date.today())),
                'payment_type': "N",
