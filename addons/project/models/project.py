    ...
    def _compute_privacy_visibility_warning(self):
        for project in self:
            project.privacy_visibility_warning = (
                'Customers will be added to the followers of their tasks.'
                    if project.privacy_visibility == 'portal' and project._origin.privacy_visibility != 'portal'
                else 'Portal users will be removed from the followers of the project and its tasks.'
                    if project.privacy_visibility != 'portal' and project._origin.privacy_visibility == 'portal'
                else ''
            )
    ...
    def _change_privacy_visibility(self, new_visibility):
        ...
        for project in self:
            ...
            if new_visibility == 'portal':
                ...
                for task in project.mapped('task_ids').filtered('partner_id'):
                ...
                project.mapped('task_ids')._unsubscribe_portal_users()
