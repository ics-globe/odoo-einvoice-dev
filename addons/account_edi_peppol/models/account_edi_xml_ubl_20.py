...
class AccountEdiXmlUBL20(models.AbstractModel):
    ...
    def _export_invoice_vals(self, invoice):
        ...
        vals = {
            ...
            'PartyNameType_template': 'account_edi_peppol.ubl_20_PartyNameType',
            'CountryType_template': 'account_edi_peppol.ubl_20_CountryType',
            'AddressType_template': 'account_edi_peppol.ubl_20_AddressType',
            'TaxSchemeType_template': 'account_edi_peppol.ubl_20_TaxSchemeType',
            'PartyTaxSchemeType_template': 'account_edi_peppol.ubl_20_PartyTaxSchemeType',
            'PartyLegalEntityType_template': 'account_edi_peppol.ubl_20_PartyLegalEntityType',
            'ContactType_template': 'account_edi_peppol.ubl_20_ContactType',
            'PartyType_template': 'account_edi_peppol.ubl_20_PartyType',
            'PartyIdentificationType_template': 'account_edi_peppol.ubl_20_PartyIdentificationType',
            'SupplierPartyType_template': 'account_edi_peppol.ubl_20_SupplierPartyType',
            'CustomerPartyType_template': 'account_edi_peppol.ubl_20_CustomerPartyType',
            'FinancialInstitutionType_template': 'account_edi_peppol.ubl_20_FinancialInstitutionType',
            'BranchType_template': 'account_edi_peppol.ubl_20_BranchType',
            'FinancialAccountType_template': 'account_edi_peppol.ubl_20_FinancialAccountType',
            'PaymentMeansType_template': 'account_edi_peppol.ubl_20_PaymentMeansType',
            'PaymentTermsType_template': 'account_edi_peppol.ubl_20_PaymentTermsType',
            'TaxCategoryType_template': 'account_edi_peppol.ubl_20_TaxCategoryType',
            'TaxSubtotalType_template': 'account_edi_peppol.ubl_20_TaxSubtotalType',
            'TaxTotalType_template': 'account_edi_peppol.ubl_20_TaxTotalType',
            'MonetaryTotalType_template': 'account_edi_peppol.ubl_20_MonetaryTotalType',
            'ItemIdentificationType_template': 'account_edi_peppol.ubl_20_ItemIdentificationType',
            'ItemType_template': 'account_edi_peppol.ubl_20_ItemType',
            'AllowanceChargeType_template': 'account_edi_peppol.ubl_20_AllowanceChargeType',
            'PriceType_template': 'account_edi_peppol.ubl_20_PriceType',
            'InvoiceLineType_template': 'account_edi_peppol.ubl_20_InvoiceLineType',
            'InvoiceType_template': 'account_edi_peppol.ubl_20_InvoiceType',
        ...
        if invoice.move_type == 'out_invoice':
            vals['main_template'] = 'account_edi_peppol.ubl_20_Invoice'
        else:
            vals['main_template'] = 'account_edi_peppol.ubl_20_CreditNote'
