...
class AccountAnalyticLine(models.Model):
    ...
    def _fields_view_get(self, view, view_type='form'):
        ...
        node = super(AccountAnalyticLine, self)._fields_view_get(view, view_type=view_type)
        node = self._apply_timesheet_label(node, view_type=view_type)
        return node

    @api.model
    def _apply_timesheet_label(self, doc, view_type='form'):
    ...
    @api.model
    def _apply_time_label(self, doc, related_model):
