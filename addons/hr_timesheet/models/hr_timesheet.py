...
class AccountAnalyticLine(models.Model):
    ...
    def _fields_view_get(self, view_id=None, view_type='form', toolbar=False, submenu=False):
        ...
        view, arch = super(AccountAnalyticLine, self)._fields_view_get(view_id=view_id, view_type=view_type, toolbar=toolbar, submenu=submenu)
    ...
    def _apply_timesheet_label(self, view_arch, view_type='form'):
        ...
        # 'string' attribute.
        for node in view_arch.xpath("//field[@name='unit_amount'][@widget='timesheet_uom'][not(@string)]"):
    ...
    def _apply_time_label(self, view_arch, related_model):
        ...
        for node in view_arch.xpath("//field[@widget='timesheet_uom'][not(@string)] | //field[@widget='timesheet_uom_no_toggle'][not(@string)]"):
