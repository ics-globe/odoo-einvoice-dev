...
class IrActionsReport(models.Model):
    ...
    def _render_qweb_pdf_prepare_streams(self, report_ref, data, res_ids=None):
        ...
        if res_ids and report_ref in ('account.report_invoice_with_payments', 'account.report_invoice'):
            ...
            if isr_inv_ids:
                isr_res = self._render_qweb_pdf_prepare_streams('l10n_ch.l10n_ch_isr_report', data, res_ids=qr_inv_ids)
