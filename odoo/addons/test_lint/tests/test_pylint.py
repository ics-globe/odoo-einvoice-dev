...
class TestPyLint(TransactionCase):
    ...
    def test_pylint(self):
        ...
        required_pylint_version = parse_version('1.6.4')
        if sys.version_info >= (3, 6):
            required_pylint_version = parse_version('1.7.0')
        if parse_version(getattr(pylint, '__version__', '0.0.1')) < required_pylint_version:
