...
class TestWebsocketRouting(common.HttpCase):
    ...
    def _assert_error_received(self, websocket, error_name):
        err = json.loads(websocket.recv())
        self.assertEqual(error_name, err['name'])
    ...
    def test_access_denied_route(self):
        ...
        with self.assertLogs(self.logger_name, level="ERROR"):
            ...
            self._assert_error_received(ws, "odoo.exceptions.AccessDenied")
    ...
    def test_access_user_route_fail(self):
        ...
        with self.assertLogs(self.logger_name, level="ERROR"):
            ...
            self._assert_error_received(ws, "odoo.http.SessionExpiredException")
    ...
    def test_call_route_invalid_path(self):
        ...
        with self.assertLogs(self.logger_name, level="ERROR"):
            ...
            self._assert_error_received(ws, "werkzeug.exceptions.NotFound")
    ...
    def test_call_route_missing_args(self):
        ...
        with self.assertLogs(self.logger_name, level="ERROR"):
            ...
            self._assert_error_received(ws, "builtins.TypeError")
    ...
    def test_call_route_invalid_json(self):
        ...
        with self.assertLogs(self.logger_name, level="ERROR"):
            ws.send('{invalidjson')
            self._assert_error_received(ws, "odoo.websocket.InvalidWebsocketRequest")
