...
class Frame:
    ...
    `PriorityQueue`: ping/pong frames are prioritary.
    """
    ...
    def __lt__(self, other):
        ...
        heartbeat_opcodes = (Opcode.PING, Opcode.PONG)
        if (self.opcode in heartbeat_opcodes and other.opcode in heartbeat_opcodes
                or self.opcode in DATA_OP and other.opcode in DATA_OP):
            return self._send_order < other._send_order
        return self.opcode in heartbeat_opcodes
